...
"""
Sample the configurations of an openmmtools test system where the amount of salt is fixed. Salt can be added such that
the ratio of water molecules to salt pairs is set to match a specified concentration of salt. The salt pairs that are
added have the same topology and mass as the ions in saltswap's fluctuating salt code.

This script is used to compare the dynamics and convergence of salt distributions for fixed salt numbers versus
fluctuating numbers.
"""
