...
if __name__ == "__main__":
    ...
    parser.add_argument('--nprop', type=int,
                        help="the number of ncmc propagation steps per perturbation kernel, default=1", default=1)
    ...
    salinator = wrappers.Salinator(context=context, system=wbox.system, topology=wbox.topology,
                                   ...
                                   pressure=pressure, temperature=temperature, npert=npert,nprop=nprop, water_name='HOH')
